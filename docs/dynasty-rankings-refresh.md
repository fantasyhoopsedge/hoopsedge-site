...
- **Prepared:** 2026-07-14 · **Last updated:** 2026-07-24
- **Covers:** `src/lib/dynasty-rankings.{ts,json}`, `/dynasty-rankings`
- **Current dataset:** v1.1 (July 2026) · 495 players — **complete.** All five experts (Dizzle, Dynatyze, MBall, Hashtag, Angle) now merged on July 2026 data; nothing carried forward. `trend`/`trendDelta` reflect the final, all-five-updated state. See §12 for the full log of this refresh.
...
*Sources: `src/lib/dynasty-rankings.{ts,json}` · `src/lib/player-name-aliases.ts` · `src/app/dynasty-rankings/**` · `scripts/swap-experts.js` · `scripts/snapshot-rankings.js` · `scripts/nba-data/roster_ingest.ts` · `dynasty ranks/*.csv` · `dynasty ranks/July 2026/*.csv` · `data/nba-rosters/2026-27.csv` · `data/nba-rosters/transactions-2026-27.md` · `data/fhe_2026_prospects_master.csv` · git log (commits `d19246d` through `74d0a88`)*
